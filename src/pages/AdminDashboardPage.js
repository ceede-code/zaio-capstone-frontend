...
const AdminDashboardPage = () => {
  ...
  const fetchData = () => {
    fetch('https://zaio-capstone-backend.onrender.com/api/reservations/host', {
  ...
  const handleDeleteReservation = async (id) => {
    await fetch(`https://zaio-capstone-backend.onrender.com/api/reservations/${id}`, {
      method: 'DELETE',
      headers: { Authorization: `Bearer ${token}` }
    });
  ...
  const handleDeleteListing = async (id) => {
    await fetch(`https://zaio-capstone-backend.onrender.com/api/accommodations/${id}`, {
      method: 'DELETE',
      headers: { Authorization: `Bearer ${token}` }
    });
